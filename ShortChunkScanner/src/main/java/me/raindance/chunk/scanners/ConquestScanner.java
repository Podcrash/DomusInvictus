...
public class ConquestScanner extends BaseWorldScanner {
    ...
    public BaseMap setUp(String worldName) {
        ...
        map.setName(worldName);
        map.setGamemode("conquest");
        map.setAuthors(new ArrayList<>());
        map.setSpawns(new HashMap<>());
        map.setCapturePointPojos(new ArrayList<>());
        map.setEmeralds(new ArrayList<>());
        map.setRestocks(new ArrayList<>());

        map.setAllowAnimals(true);
        map.setAllowMonsters(true);
        map.setAllowPvP(true);
        map.setEnvironment("normal");
        map.setWorldType("default");
